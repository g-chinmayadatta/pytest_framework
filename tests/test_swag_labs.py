...
from utils.soft_assertions import SoftAssertion
from utils.logger import logger
from utils.wait_utils import WaitUtils
from utils.config_reader import ConfigReader

_users = ConfigReader.load_users()

class TestSwagLabs:

    def _common_setup(self, driver, get_user):
        self.custom_driver = driver
        self.user, self.password = get_user.get('username'),get_user.get('password')
    ...
    @pytest.mark.login
    @pytest.mark.smoke
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_login_valid(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.ui
    @pytest.mark.login
    @pytest.mark.parametrize("get_user", [{"user":"locked"}] ,indirect=True)
    def test_login_locked(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.login
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_login_invalid_input(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.login
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_login_empty_user_input(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.user = ''
    ...
    @pytest.mark.login
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_login_empty_password_input(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.password = ''
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_inventory_products(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
        inventory_page_displayed = self.inventory.check_inventory_page_displayed()
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_inventory_products_titles(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
        inventory_page_displayed = self.inventory.check_inventory_page_displayed()
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_inventory_products_price(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_sort_titles(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_sort_titles_reverse(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_sort_price(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_sort_price_reverse(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_product_add_to_cart(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user, self.password)
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_product_remove_from_cart(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
        ...
        logger.info(f"the cartcount is {cart_count} and the after remove {after_remove}")
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_product_add_multiple(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
    ...
    @pytest.mark.inventory
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_cart_navigation(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user, self.password)
    ...
    @pytest.mark.ui
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_logout(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
        inventory_page_displayed = self.inventory.check_inventory_page_displayed()
    ...
    @pytest.mark.smoke
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_order_summary(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
        products = ["Sauce Labs Bolt T-Shirt","Sauce Labs Backpack"]
        _checkout = _users["checkout"]
        details = {"first name": _checkout["first_name"], "last name": _checkout["last_name"], "postal": _checkout["postal"]}
        self.inventory.add_products_to_cart(products)
        self.inventory.click_cart()
    ...
    @pytest.mark.cart
    @pytest.mark.parametrize("get_user", [{"user":"standard"}] ,indirect=True)
    def test_checkout_empty_user_details(self, open_browser, get_user):
        self._common_setup(open_browser, get_user)
        self.login_page.login(self.user,self.password)
        products = ["Sauce Labs Bolt T-Shirt","Sauce Labs Backpack"]
        self.inventory.add_products_to_cart(products)
